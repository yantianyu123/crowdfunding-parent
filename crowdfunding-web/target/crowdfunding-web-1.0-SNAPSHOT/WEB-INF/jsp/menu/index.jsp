            ...
            <div class="modal-body">
                <form role="form" id="for1">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addName" name="name" placeholder="请输入菜单名">
                    </div>
                    <div class="form-group">
                        <label>菜单地址</label>
                        <input type="text" class="form-control" id="addUrl" name="url" placeholder="请输入菜单地址">
                    </div>
                    <div class="form-group">
                        <label>菜单样式</label>
                        <input type="text" class="form-control" id="addIcon" name="icon" placeholder="请输入菜单样式">
                    </div>
                </form>
            </div>
...
<div id="updateModal" class="modal fade" tabindex="-1" role="dialog">
            ...
            <div class="modal-body">
                <form role="form" id="for2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="updateName" name="name" placeholder="请输入菜单名">
                    </div>
                    <div class="form-group">
                        <label>菜单地址</label>
                        <input type="text" class="form-control" id="updateUrl" name="url" placeholder="请输入菜单地址">
                    </div>
                    <div class="form-group">
                        <label>菜单样式</label>
                        <input type="text" class="form-control" id="updateIcon" name="icon" placeholder="请输入菜单样式">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
	...
	<script type="text/javascript">
		...
		function initzTree() {
			...
			$.ajax({
                type:"get",
                url:"${PATH}/menu/loadData",
                success:function(backData) {
                    var  zNodes = backData;
                    //手动添加根节点
                    zNodes.push({id:0,name:"系统权限菜单",icon:"glyphicon glyphicon-th"});
        ...
        function updateModal(id) {
		    $.ajax({
                ...
                success:function(backData) {
                    ...
                    $("#for2 input[name='url']").val(backData.url);
        ...
        function deleteModal(id) {
		    ...
		    layer.confirm('确定要删除该条数据吗？',{btn:['确定','取消']}
                    ,function (index) {
                       $.get("${PATH}/menu/delete",{id:id},function() {
                            initzTree();
                        });
                        layer.close(index);
                    },function (index) {
